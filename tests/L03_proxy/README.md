...
This directory groups L03_proxy verification by scenario.
...
```powershell
.\venv\Scripts\python.exe tests/L03_proxy/local_mvp/test_local_mvp.py
```

Reports for this scenario are stored in:

```text
tests/L03_proxy/local_mvp/reports/
```
...
```powershell
.\venv\Scripts\python.exe tests/L03_proxy/openai_agent/run_openai_agent_verification.py
```

Reports for this scenario are stored in:

```text
tests/L03_proxy/openai_agent/reports/
```
