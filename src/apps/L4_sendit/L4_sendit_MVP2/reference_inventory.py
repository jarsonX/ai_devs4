# Deterministic local reference inventory for L4 sendit MVP2 source selection.
...
REFERENCE_HINTS = {
    ...
    "zalacznik-G.md": "attachment G and WDP meaning",
    "zalacznik-H.md": "attachment H",
    "dodatkowe-wagony.md": "additional wagon information",
    "trasy-wylaczone.png": "disabled routes image/table",
}
...
# Classify a local reference file into the source types accepted by Stage 2.
