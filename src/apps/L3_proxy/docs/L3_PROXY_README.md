...
L3_proxy is an educational app for the AI_devs course.
...
- [Workflow Stages](#workflow-stages)
  - [1. Intake](#1-intake)
  - [2. Conversation And Tool Loop](#2-conversation-and-tool-loop)
  - [3. Response Finalization](#3-response-finalization)
...
- [Planned Functions And Contracts](#planned-functions-and-contracts)
  ...
  - [Reactor Context Classification](#reactor-context-classification)
