# This module submits the public L03_proxy endpoint URL to the course verification hub.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Submit the public L03_proxy endpoint URL to the course hub.",
    )
    parser.add_argument(
        "public_url",
        help="Public pinggy URL pointing to the L03_proxy POST endpoint.",
    )
    parser.add_argument(
        "--session-id",
